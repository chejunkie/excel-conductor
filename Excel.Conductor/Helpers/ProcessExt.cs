...
namespace ChEJunkie.Office.Excel
{
    ...
    public static class ProcessExtensionMethods
    {
        ...
        public static int MainWindowZ(this Process process)
        {
            ...
            return WinApi.GetWindowZ(process.MainWindowHandle.ToInt32());
        }
        ...
        public static Process? TopMost(this IEnumerable<Process> processes)
        {
            ...
            Process? process = OrderByZ(processes).FirstOrDefault();
        ...
        public static xlApp AsExcelApp(this Process process)
        {
            ...
            var result = SessionUtil.AppFromMainWindowHandle(handle);
